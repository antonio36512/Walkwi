  ...
  useEffect(() => {
    ...
    async function fetchWalker() {
      try {
        ...
        const reviewData = await apiRequest(`/api/reviews/walker/${id}`);
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.profileHeader}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.statItem}>
              ...
              <Text style={styles.statValue}>{Number(walker.rating || 0).toFixed(1)}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.ratingBlock}>
            <Text style={styles.ratingBig}>{Number(walker.rating || 0).toFixed(1)}</Text>
            <View>
          ...
          {(showAllReviews ? reviews : reviews.slice(0, 3)).map((review) => (
            <View key={review._id} style={styles.reviewItem}>
              <View style={styles.reviewItemHeader}>
                <Text style={styles.reviewAuthor}>Usuario de Walkwi</Text>
          ...
          {reviews.length > 3 && (
            <Pressable style={styles.reviewsToggle} onPress={() => setShowAllReviews((value) => !value)}>
                        ...
                        <View style={styles.summaryRow}>
                          ...
                          <View style={styles.summaryInfo}>
                            ...
                            <View style={styles.summaryRatingRow}>
                              ...
                              <Text style={styles.summaryRating}>{Number(walker.rating || 0).toFixed(1)}</Text>
                            </View>
                          </View>
                        </View>
...
const styles = StyleSheet.create({
  ...
  reviewItem: { backgroundColor:colors.secondarySoft, borderRadius:14, marginTop:12, padding:14 },
  reviewItemHeader: { alignItems:'center', flexDirection:'row', justifyContent:'space-between' },
  reviewAuthor: { color:colors.text, fontSize:14, fontWeight:'900' },
  reviewStars: { color:'#f59e0b', fontSize:16 },
  reviewComment: { color:colors.textMuted, fontSize:14, lineHeight:20, marginTop:8 },
  reviewsToggle: { alignItems:'center', borderColor:colors.line, borderRadius:14, borderWidth:1, flexDirection:'row', justifyContent:'center', marginTop:12, paddingVertical:12 },
  reviewsToggleText: { color:colors.primary, fontSize:14, fontWeight:'900', marginRight:6 },
  stickyFooter: {
    alignItems: 'center',
